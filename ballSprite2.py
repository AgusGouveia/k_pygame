...
class Marcador(pg.sprite.Sprite):
    ...
    def __init__(self, x, y, justificado = None, fontsize=25, color=(255,255,255)):
        ...
        self.image = None #No es necesario, pero es bueno tener informado todas las variables que usamos.
        self.rect = None

    def update(self, dt): #Debemos colocar el dt en todos los update aunque algunos no lo usen porque el Group lo pedirá.
...
class Ladrillo(pg.sprite.Sprite):
    ...
    def cargaImagenes(self): 
        imagenes = [] #Creamos lista vacia
        for fichero in self.disfraces: #A los que haya en disfraces aplicas...
            imagenes.append(pg.image.load("./images/{}".format(fichero))) #Agregamos disfraces a nuestra lista vacia y cargamos las imagenes
        return imagenes
    ...
    def __init__(self):
        ...
        for fila in range(4):
            for columna in range(8):
                x = columna * 100 + 5 #el 5 es la distancia entre los ladrillos
                y = fila * 40 + 5
